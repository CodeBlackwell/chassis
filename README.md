...
docs/    architecture, extensibility, stack pro/cons matrix
```

## Docs

- [docs/architecture.md](docs/architecture.md) — the system at rest, the trace bus, query flow, the two couplings.
- [docs/extensibility.md](docs/extensibility.md) — how to add an adapter or a layer, add a profile, and re-skin CHASSIS into a new project.
- [docs/stack-matrix.md](docs/stack-matrix.md) — per-layer pro/cons matrix with defaults and switch triggers.
